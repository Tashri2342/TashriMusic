...
import config
from TashriX import Carbon, YouTube, app
from TashriX.core.call import Tashri
from TashriX.misc import db
from TashriX.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from TashriX.utils.exceptions import AssistantErr
from TashriX.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
from TashriX.utils.inline.playlist import close_markup
from TashriX.utils.pastebin import Tashribin
from TashriX.utils.stream.queue import put_queue, put_queue_index
from TashriX.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await Tashri.force_stop_stream(chat_id)
