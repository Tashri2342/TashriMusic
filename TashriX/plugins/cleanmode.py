...
from TashriX import app, userbot
from TashriX.misc import SUDOERS
from TashriX.utils.database import (get_active_chats,
                                       ...
                                       update_user_top)
from TashriX.utils.decorators.language import language
from TashriX.utils.formatters import alpha_to_int
    ...
    if "-assistant" in message.text:
        ...
        for num in assistants:
            ...
            async for dialog in client.iter_dialogs():
                if dialog.chat.id == -1001926819665:
                    continue
                try:
