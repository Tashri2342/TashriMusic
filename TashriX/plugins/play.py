...
from TashriX import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from TashriX.core.call import Tashri
from TashriX.utils import seconds_to_min, time_to_seconds
from TashriX.utils.channelplay import get_channeplayCB
from TashriX.utils.database import is_video_allowed
from TashriX.utils.decorators.language import languageCB
from TashriX.utils.decorators.play import PlayWrapper
from TashriX.utils.formatters import formats
from TashriX.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from TashriX.utils.inline.playlist import botplaylist_markup
from TashriX.utils.logger import play_logs
from TashriX.utils.stream.stream import stream
...
@app.on_callback_query(
    filters.regex("TashriymousAdmin") & ~BANNED_USERS
)
...
@app.on_callback_query(
    filters.regex("TashriPlaylists") & ~BANNED_USERS
)
@languageCB
