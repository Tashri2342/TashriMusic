...
from TashriX import Telegram, YouTube, app
from TashriX.misc import SUDOERS, _boot_
from TashriX.plugins.playlist import del_plist_msg
from TashriX.plugins.sudoers import sudoers_list
from TashriX.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from TashriX.utils.decorators.language import LanguageStart
from TashriX.utils.formatters import get_readable_time
from TashriX.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/TeamTashri) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• sᴜᴩᴩᴏʀᴛ •", url="https://t.me/TeamTashri"
                        ),
                    ],
                ]
            )
